...
var Ship = Asteroids.Ship = function (obj) {
  ...
  this.img = new Image();
  this.img.src = 'lib/images/explosion.gif';
  this.rotation = 0.02;
  this.angle = 90;
};
...
//   } else {
//     this.pos = [currentGame.width/2, currentGame.height/2];
//     this.vel = [0,0];
//   }
// };
...
Ship.prototype.power = function (direction) {
  var that = this
  var xVector = Asteroids.Util.cos(that.angle) * direction * 0.01;
  var yVector = Asteroids.Util.sin(that.angle) * direction * 0.01;
  this.vel[0] += xVector;
  this.vel[1] += yVector;
};
