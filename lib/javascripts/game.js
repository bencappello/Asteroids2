...
Game.prototype.newLife = function () {
  ...
  var explosionPos = []
  explosionPos[0] = this.ship.pos[0] - (this.ship.radius*1.5);
  explosionPos[1] = this.ship.pos[1] - (this.ship.radius*1.5);
  lives -= 1;
  if (lives <= 0) {
    ...
    this.explosion.explode(this.reset.bind(this), explosionPos);
  }
};
