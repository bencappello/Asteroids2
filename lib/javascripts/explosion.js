...
ShipExplosion.prototype.explode = function (callback, pos) {
  ...
  Asteroids.Util.repeat(increase_frame.bind(this), 60, 25, callback);
};

AsteroidExplosion.prototype.explode = function (callback, pos) {
  var increase_frame = function() {
    this.frame += 1;
  };
  this.frame = 1;
  this.pos[0] = pos[0];
  this.pos[1] = pos[1];
  Asteroids.Util.repeat(increase_frame.bind(this), 100, 40, callback);
};
