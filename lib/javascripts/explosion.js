...
Explosion.prototype.explode = function (callback, pos) {
  ...
  this.pos[0] = pos[0];
  this.pos[1] = pos[1];
  Asteroids.Util.repeat(reduce_frame.bind(this), 100, 25, callback);
};
...
Explosion.prototype.draw = function (ctx) {
  ...
  var spriteWidth = img_obj.width / img_obj.total_frames;
  var spriteHeight = img_obj.height;
  ...
  ctx.drawImage(this.img.src, spriteX, spriteY,
